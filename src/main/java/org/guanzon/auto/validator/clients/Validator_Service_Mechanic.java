 ...
 * @author Arsiela
 */
public class Validator_Service_Mechanic implements ValidatorInterface {
    GRider poGRider;
    String psMessage;
    
    Model_Service_Mechanic poEntity;
    
    public Validator_Service_Mechanic(Object foValue){
        poEntity = (Model_Service_Mechanic) foValue;
    }
        ...
        try {
            ...
            if(poEntity.getEditMode() == EditMode.ADDNEW){
                ...
                if (MiscUtil.RecordCount(loRS) > 0){
                    ...
                    psMessage = "Existing Service Mechanic Record.\n\nEmployee ID: " + lsClientID + "\nName: " + lsCompnyNm.toUpperCase() ;
                    MiscUtil.close(loRS);        
                    return false;
                }
            }
        } catch (SQLException ex) {
            Logger.getLogger(Validator_Service_Mechanic.class.getName()).log(Level.SEVERE, null, ex);
        }
        return true;
    }
